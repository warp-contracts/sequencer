...
type NextArweaveBlock struct {
	...
	Transactions []github_com_warp_contracts_syncer_src_utils_arweave.Transaction `protobuf:"bytes,2,rep,name=transactions,proto3,customtype=github.com/warp-contracts/syncer/src/utils/arweave.Transaction" json:"transactions"`
}
...
var fileDescriptor_fcf042f23dd624dc = []byte{
	...
	,
}
...
func (m *NextArweaveBlock) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Transactions) > 0 {
		for iNdEx := len(m.Transactions) - 1; iNdEx >= 0; iNdEx-- {
			{
				size := m.Transactions[iNdEx].Size()
				i -= size
				if _, err := m.Transactions[iNdEx].MarshalTo(dAtA[i:]); err != nil {
					return 0, err
				}
...
func (m *NextArweaveBlock) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			var v github_com_warp_contracts_syncer_src_utils_arweave.Transaction
