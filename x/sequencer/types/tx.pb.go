...
type MsgDataItem struct {
	...
	DataItem []byte `protobuf:"bytes,2,opt,name=data_item,json=dataItem,proto3" json:"data_item,omitempty" validate:"max=104857600"`
}
...
func (m *MsgDataItem) GetDataItem() []byte {
	if m != nil {
		return m.DataItem
	}
	return nil
...
var fileDescriptor_0ca98cc63da9ee56 = []byte{
	...
	,
}
...
func (m *MsgDataItem) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DataItem) > 0 {
		i -= len(m.DataItem)
		copy(dAtA[i:], m.DataItem)
		i = encodeVarintTx(dAtA, i, uint64(len(m.DataItem)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Creator) > 0 {
...
func (m *MsgDataItem) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.DataItem = append(m.DataItem[:0], dAtA[iNdEx:postIndex]...)
			if m.DataItem == nil {
				m.DataItem = []byte{}
			}
			iNdEx = postIndex
