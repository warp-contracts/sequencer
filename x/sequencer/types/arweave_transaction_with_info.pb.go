...
func (m *ArweaveTransactionWithInfo) GetPrevSortKey() string {
	if m != nil {
...
var fileDescriptor_4153d8a6a8367bf0 = []byte{
	...
	0x82, 0x90, 0xf5, 0x0a, 0x29, 0x71, 0xf1, 0x16, 0x14, 0xa5, 0x96, 0xc5, 0x17, 0xe7, 0x17, 0x95,
	...
	0x00, 0x00, 0xff, 0xff, 0xe3, 0x95, 0xc3, 0xe6, 0x7c, 0x01, 0x00, 0x00,
}
...
func (m *ArweaveTransactionWithInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PrevSortKey) > 0 {
		...
		i = encodeVarintArweaveTransactionWithInfo(dAtA, i, uint64(len(m.PrevSortKey)))
		i--
		dAtA[i] = 0x12
	}
