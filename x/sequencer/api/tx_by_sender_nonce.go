...
func RegisterTxBySenderNonceAPIRoute(clientCtx client.Context, router *mux.Router) {
	router.Handle("/api/v1/tx-sender-nonce", txBySenderNonceHandler{ctx: clientCtx, validate: validator.New()}).Methods("POST")
}
