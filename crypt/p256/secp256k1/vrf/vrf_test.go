...
import (
	"encoding/hex"
	"fmt"
	"github.com/warp-contracts/sequencer/crypt/p256"
...
func TestVRF(t *testing.T) {
	priv, _ := p256.NewPrivateKey(keystore.SECP256K1, nil)
	...
	fmt.Println("1:", hex.EncodeToString(seckey))
	fmt.Println("2:", hex.EncodeToString(seckeypub))
