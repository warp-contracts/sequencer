...
void bench_context_verify(void* arg) {
    ...
    (void)arg;
    for (i = 0; i < 20; i++) {
        warp_secp256k1_context_destroy(warp_secp256k1_context_create(SECP256K1_CONTEXT_VERIFY));
    }
}
...
void bench_context_sign(void* arg) {
    ...
    (void)arg;
    for (i = 0; i < 200; i++) {
        warp_secp256k1_context_destroy(warp_secp256k1_context_create(SECP256K1_CONTEXT_SIGN));
    }
}
