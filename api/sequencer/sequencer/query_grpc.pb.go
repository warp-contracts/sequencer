...
const (
	Query_Params_FullMethodName           = "/sequencer.sequencer.Query/Params"
	Query_LastArweaveBlock_FullMethodName = "/sequencer.sequencer.Query/LastArweaveBlock"
	Query_PrevSortKey_FullMethodName      = "/sequencer.sequencer.Query/PrevSortKey"
	Query_PrevSortKeyAll_FullMethodName   = "/sequencer.sequencer.Query/PrevSortKeyAll"
)
...
func (c *queryClient) LastArweaveBlock(ctx context.Context, in *QueryGetLastArweaveBlockRequest, opts ...grpc.CallOption) (*QueryGetLastArweaveBlockResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_LastArweaveBlock_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) PrevSortKey(ctx context.Context, in *QueryGetPrevSortKeyRequest, opts ...grpc.CallOption) (*QueryGetPrevSortKeyResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_PrevSortKey_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) PrevSortKeyAll(ctx context.Context, in *QueryAllPrevSortKeyRequest, opts ...grpc.CallOption) (*QueryAllPrevSortKeyResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_PrevSortKeyAll_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) LastArweaveBlock(context.Context, *QueryGetLastArweaveBlockRequest) (*QueryGetLastArweaveBlockResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LastArweaveBlock not implemented")
}
func (UnimplementedQueryServer) PrevSortKey(context.Context, *QueryGetPrevSortKeyRequest) (*QueryGetPrevSortKeyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PrevSortKey not implemented")
}
func (UnimplementedQueryServer) PrevSortKeyAll(context.Context, *QueryAllPrevSortKeyRequest) (*QueryAllPrevSortKeyResponse, error) {
...
func _Query_LastArweaveBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_LastArweaveBlock_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_PrevSortKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_PrevSortKey_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_PrevSortKeyAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_PrevSortKeyAll_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
