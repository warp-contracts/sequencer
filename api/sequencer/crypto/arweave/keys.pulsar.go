...
func init() {
	file_sequencer_crypto_arweave_keys_proto_init()
	md_PubKey = File_sequencer_crypto_arweave_keys_proto.Messages().ByName("PubKey")
...
func (x *PubKey) slowProtoReflect() protoreflect.Message {
	mi := &file_sequencer_crypto_arweave_keys_proto_msgTypes[0]
...
func (x *fastReflection_PubKey) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "sequencer.crypto.arweave.PubKey.key":
		return len(x.Key) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sequencer.crypto.arweave.PubKey"))
		}
		panic(fmt.Errorf("message sequencer.crypto.arweave.PubKey does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PubKey) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message sequencer.crypto.arweave.PubKey does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PubKey) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "sequencer.crypto.arweave.PubKey.key":
		panic(fmt.Errorf("field key of message sequencer.crypto.arweave.PubKey is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sequencer.crypto.arweave.PubKey"))
		}
...
func (x *fastReflection_PubKey) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in sequencer.crypto.arweave.PubKey", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_sequencer_crypto_arweave_keys_proto_init()
	md_PrivKey = File_sequencer_crypto_arweave_keys_proto.Messages().ByName("PrivKey")
...
func (x *PrivKey) slowProtoReflect() protoreflect.Message {
	mi := &file_sequencer_crypto_arweave_keys_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_PrivKey) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "sequencer.crypto.arweave.PrivKey.key":
		return len(x.Key) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sequencer.crypto.arweave.PrivKey"))
		}
		panic(fmt.Errorf("message sequencer.crypto.arweave.PrivKey does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PrivKey) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message sequencer.crypto.arweave.PrivKey does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PrivKey) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "sequencer.crypto.arweave.PrivKey.key":
		panic(fmt.Errorf("field key of message sequencer.crypto.arweave.PrivKey is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sequencer.crypto.arweave.PrivKey"))
		}
...
func (x *fastReflection_PrivKey) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in sequencer.crypto.arweave.PrivKey", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: sequencer/crypto/arweave/keys.proto
...
func (*PubKey) Descriptor() ([]byte, []int) {
	return file_sequencer_crypto_arweave_keys_proto_rawDescGZIP(), []int{0}
}
...
func (*PrivKey) Descriptor() ([]byte, []int) {
	return file_sequencer_crypto_arweave_keys_proto_rawDescGZIP(), []int{1}
}
...
var File_sequencer_crypto_arweave_keys_proto protoreflect.FileDescriptor

var file_sequencer_crypto_arweave_keys_proto_rawDesc = []byte{
	0x0a, 0x23, 0x73, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x65, 0x72, 0x2f, 0x63, 0x72, 0x79, 0x70,
	0x74, 0x6f, 0x2f, 0x61, 0x72, 0x77, 0x65, 0x61, 0x76, 0x65, 0x2f, 0x6b, 0x65, 0x79, 0x73, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x18, 0x73, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x65, 0x72,
	0x2e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x2e, 0x61, 0x72, 0x77, 0x65, 0x61, 0x76, 0x65, 0x1a,
	0x14, 0x67, 0x6f, 0x67, 0x6f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x67, 0x6f, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x1a, 0x0a, 0x06, 0x50, 0x75, 0x62, 0x4b, 0x65, 0x79, 0x12,
	...
	,
}

var (
	file_sequencer_crypto_arweave_keys_proto_rawDescOnce sync.Once
	file_sequencer_crypto_arweave_keys_proto_rawDescData = file_sequencer_crypto_arweave_keys_proto_rawDesc
)

func file_sequencer_crypto_arweave_keys_proto_rawDescGZIP() []byte {
	file_sequencer_crypto_arweave_keys_proto_rawDescOnce.Do(func() {
		file_sequencer_crypto_arweave_keys_proto_rawDescData = protoimpl.X.CompressGZIP(file_sequencer_crypto_arweave_keys_proto_rawDescData)
	})
	return file_sequencer_crypto_arweave_keys_proto_rawDescData
}

var file_sequencer_crypto_arweave_keys_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_sequencer_crypto_arweave_keys_proto_goTypes = []interface{}{
	(*PubKey)(nil),  // 0: sequencer.crypto.arweave.PubKey
	(*PrivKey)(nil), // 1: sequencer.crypto.arweave.PrivKey
}
var file_sequencer_crypto_arweave_keys_proto_depIdxs = []int32{
...
func init() { file_sequencer_crypto_arweave_keys_proto_init() }
func file_sequencer_crypto_arweave_keys_proto_init() {
	if File_sequencer_crypto_arweave_keys_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_sequencer_crypto_arweave_keys_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PubKey); i {
			case 0:
				return &v.state
			case 1:
		...
		file_sequencer_crypto_arweave_keys_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_sequencer_crypto_arweave_keys_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_sequencer_crypto_arweave_keys_proto_goTypes,
		DependencyIndexes: file_sequencer_crypto_arweave_keys_proto_depIdxs,
		MessageInfos:      file_sequencer_crypto_arweave_keys_proto_msgTypes,
	}.Build()
	File_sequencer_crypto_arweave_keys_proto = out.File
	file_sequencer_crypto_arweave_keys_proto_rawDesc = nil
	file_sequencer_crypto_arweave_keys_proto_goTypes = nil
	file_sequencer_crypto_arweave_keys_proto_depIdxs = nil
}
